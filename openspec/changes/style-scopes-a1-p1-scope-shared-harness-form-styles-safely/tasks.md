...
- [ ] 1.1 Rename the shared harness form selectors in `app/globals.css` from
      generic names to one app-specific namespace and keep the related rules in
      a clearly scoped block.
- [ ] 1.2 Preserve the current shared form layout and interaction styling while
...
- [ ] 2.1 Update `components/team-console.tsx`,
...
- [ ] 2.2 Verify there are no remaining harness call sites that depend on the
...
- [ ] 3.1 Run `pnpm lint` after the class-name and JSX updates land.
- [ ] 3.2 Review the affected form surfaces for preserved layout and interaction
