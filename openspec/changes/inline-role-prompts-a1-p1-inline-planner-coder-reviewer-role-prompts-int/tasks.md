...
- [ ] 1.1 Review the approved OpenSpec artifacts for "Inline planner/coder/reviewer role prompts into `lib/team/roles`" and confirm the canonical request/PR title is `refactor(team/roles): Inline planner/coder/reviewer role prompts into`
...
- [ ] 2.2 Run validation and capture reviewer findings for "Inline planner/coder/reviewer role prompts into `lib/team/roles`"
