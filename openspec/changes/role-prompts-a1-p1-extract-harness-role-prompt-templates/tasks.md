...
- [x] 1.1 Review the approved OpenSpec artifacts for "Extract harness role prompt templates" and confirm the canonical request/PR title is `refactor(team/roles): Extract harness role prompt templates`
