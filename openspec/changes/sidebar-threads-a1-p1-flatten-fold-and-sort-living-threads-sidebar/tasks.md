...
- [ ] 1.1 Review the approved OpenSpec artifacts for "Flatten, fold, and sort Living Threads sidebar" and confirm the canonical request/PR title is `feat: Flatten, fold, and sort Living Threads sidebar`
...
- [ ] 2.2 Run validation and capture reviewer findings for "Flatten, fold, and sort Living Threads sidebar"
