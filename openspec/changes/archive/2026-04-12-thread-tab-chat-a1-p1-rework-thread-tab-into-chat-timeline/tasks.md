...
- [x] 1.1 Review the approved OpenSpec artifacts for "Rework Thread Tab Into Chat Timeline" and confirm the canonical request/PR title is `feat: Rework Thread Tab Into Chat Timeline`
