...
- [x] 1.1 Review the approved OpenSpec artifacts for "Use static worktrees per thread" and confirm the canonical request/PR title is `refactor: Use static worktrees per thread`
...
- [x] 2.2 Run validation and capture reviewer findings for "Use static worktrees per thread"
