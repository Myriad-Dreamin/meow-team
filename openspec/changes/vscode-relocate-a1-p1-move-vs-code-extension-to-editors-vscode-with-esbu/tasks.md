...
- [x] 1.1 Review the approved OpenSpec artifacts for "Move VS Code extension to `editors/vscode` with esbuild and backend-routed notifications" and confirm the canonical request/PR title is `feat: Move VS Code extension to `editors/vscode` with esbuild and backend-routed`
...
- [x] 2.2 Run validation and capture reviewer findings for "Move VS Code extension to `editors/vscode` with esbuild and backend-routed notifications"
