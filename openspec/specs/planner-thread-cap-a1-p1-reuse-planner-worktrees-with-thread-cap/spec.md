# planner-thread-cap-a1-p1-reuse-planner-worktrees-with-thread-cap Specification

## Purpose

Define the capped planner worktree reuse capability for the harness,
including shared `meow-N` staging slots, a matching cap on concurrent
non-terminal threads, and tested slot assignment, reuse, release, and
