# commit-prefixes-a1-p1-standardize-conventional-commit-prefixes Specification

## Purpose

Define deterministic harness-managed commit-subject formatting so planner and
coder automation, archive flows, and direct agent-authored commits all use the
same lowercase `docs:`, `dev:`, `fix:`, and `test:` prefixes.
