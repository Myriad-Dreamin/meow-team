# inject-team-roles-a1-p1-inject-executor-and-schema-first-team-role-modul Specification

## Purpose

Define the injected executor and schema-first team role capability for the
harness, including extracted CLI execution, request-title, planner, coder,
and reviewer modules, deterministic `runTeam` dispatch with production
defaults, and mock-driven tests.
