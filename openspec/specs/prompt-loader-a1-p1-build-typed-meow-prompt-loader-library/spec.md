# prompt-loader-a1-p1-build-typed-meow-prompt-loader-library Specification

## Purpose

Define the typed `meow-prompt` loader capability for the harness, including
markdown template parsing, typed direct imports, builtin raw pipes, initial
tests, and AGENTS syntax documentation.
