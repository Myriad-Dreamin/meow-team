# parallel-worktrees-a1-p1-fix-parallel-worktree-allocation Specification

## Purpose

Define the parallel worktree allocation capability for the harness,
including dedicated planner staging worktrees, shared cross-thread coder and
reviewer slot allocation, slot reuse for active lanes, and regression
coverage for concurrent runs.
