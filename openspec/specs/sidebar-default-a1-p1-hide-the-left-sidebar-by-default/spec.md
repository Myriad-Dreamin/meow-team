# sidebar-default-a1-p1-hide-the-left-sidebar-by-default Specification

## Purpose

Define the default-collapsed workspace sidebar behavior so the editor is the
initial focus area while an always-visible status-bar toggle keeps thread
navigation reachable without disturbing the current workspace context.
