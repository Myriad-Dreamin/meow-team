# ugit-platform-a1-p1-add-ugit-platform-adapter-and-config-based-dispatch Specification

## Purpose

Define the harness ugit-platform capability so repositories that set
`meow-team.platform=ugit` resolve a first-class ugit adapter for remote
normalization, branch publishing, and pull-request synchronization while
preserving GitHub as the default platform.
