# thread-tab-chat-a1-p1-rework-thread-tab-into-chat-timeline Specification

## Purpose

Define the selected thread detail experience as a chat-style timeline with a
primary-lane quick-link header, bottom-anchored scrolling, right-rail
navigation, and lazy stderr history loading that keeps long-running threads
responsive without regressing existing approval or feedback flows.
