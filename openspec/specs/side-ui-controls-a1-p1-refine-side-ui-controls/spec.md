# side-ui-controls-a1-p1-refine-side-ui-controls Specification

## Purpose

Define the refined side UI controls capability for the harness, including
icon-based Run Team and Settings entry points, relocation of desktop alert
controls into the Settings tab, removal of redundant labels, and preserved
thread and status behavior.
