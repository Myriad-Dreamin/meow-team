# machine-review-pr-a1-p1-complete-machine-reviewed-approval-archive-and-g Specification

## Purpose

Define the machine-reviewed approval and PR finalization capability for the
harness, including a separate machine-reviewed approval step, on-branch
OpenSpec archiving for the approved lane, and creation or refresh of a
GitHub PR into `main` after human approval.
