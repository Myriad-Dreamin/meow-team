# inline-role-prompts-a1-p1-inline-planner-coder-reviewer-role-prompts-int Specification

## Purpose

Define the harness role prompt ownership capability so planner, coder, and
reviewer prompt templates under `lib/team/roles` remain the single runtime
source for role instructions and metadata.
