# execute-mode-a1-p1-add-execute-mode-workflow-and-roles Specification

## Purpose

Define the execute-mode harness workflow so prefixed execution, benchmark, and
experiment requests persist subtype metadata, route through executor and
execution-reviewer stages, and require reviewable guidance plus validation
artifacts without regressing the default coder/reviewer path.
