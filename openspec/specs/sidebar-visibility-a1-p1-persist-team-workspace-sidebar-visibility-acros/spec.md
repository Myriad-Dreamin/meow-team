# sidebar-visibility-a1-p1-persist-team-workspace-sidebar-visibility-acros Specification

## Purpose

Define browser-local TeamWorkspace sidebar visibility persistence so refreshes
restore the owner's last open or closed state without changing the existing
collapsed fallback, toggle UX, or focused regression coverage expectations.
