# cli-tools-a2-p1-centralize-cli-command-runners Specification

## Purpose

Define the shared CLI command-runner capability for the harness, including a
centralized `execFile` utility for `git`, `gh`, and `openspec` wrappers while
preserving existing caller-facing behavior and failure reporting.
## Requirements
