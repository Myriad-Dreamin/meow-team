# meow-prompt-vite-a1-p1-remove-turbopack-and-direct-vite-loading Specification

## Purpose

Define the direct Vite-backed `meow-prompt` loading capability for the
harness, including removal of Turbopack-specific integration, Vite-managed
prompt loading for `app` and optional `docs`, and preserved typed prompt
imports under the new flow.
