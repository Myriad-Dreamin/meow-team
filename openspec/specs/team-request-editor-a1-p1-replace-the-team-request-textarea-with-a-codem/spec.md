# team-request-editor-a1-p1-replace-the-team-request-textarea-with-a-codem Specification

## Purpose

Define the Continuous Assignment Console request editor capability that
