...
| `app/api/team/threads/[threadId]/archive/route.ts` | `POST /api/team/threads/:threadId/archive` | [docs/api/team/threads/threadId/archive.md](/api/team/threads/threadId/archive) |
